;
; See credit below for original code!!!
;
; (c) 2017 Jouni 'Mr.Spiv' Korhonen
; An attempt to make a raster effect friendly PT3 player. The regoutput
; is done in a constant time and thus can be used in places that require
; cycle exact timing.
;
; v0.1
;
...
e:
    ...
    IF 1
        SAVEBIN "vt.bin",j,e-j
        IF ((_ERRORS = 0) + (_WARNINGS = 0))
            SHELLEXEC "bin2tap -b -c 33279 -a 33280 -r 33280 -o vt.tap vt.bin"
        ENDIF
    ELSE
        SAVESNA "vt.sna",j
    ENDIF
