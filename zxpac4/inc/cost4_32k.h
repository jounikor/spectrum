...
#ifndef _COST4_32K_INCLUDED
#define _COST4_32K_INCLUDED

#include "lz_base.h"
#include "mtf256.h"

#ifdef MTF_CTX_SAVING_ENABLED
#define ZXPAC4_32K_MTF_CTX_SIZE   128   // This is a bit of dirty forward knowledge how
                                    // mtf256 works.. just to avoid dynamic memory
                                    // allocation for all contexts..
#endif

class zxpac4_32k_cost: public lz_cost<zxpac4_32k_cost> {
    //mtf_encode m_mtf;
    bool m_debug;
    bool m_verbose;
public:
