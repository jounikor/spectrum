...
;
; Z80 decompressor for zxpac4b reversed files
;
; Use e.g. following to assemble:
;  pasmo --tapbas --alocal -1 z80rdecb.asm rtap.tap
;
...
_get_runlen_loop:
        GETBIT
        jr nc,  _get_runlen_exit
        GETBIT
        rl      c       ; clears C-flags
        djnz    _get_runlen_loop
_get_runlen_exit:
        ex      af,af'
        ld      a,c
        pop     bc
